...
case class Tile38IdNotFoundError(ok: Boolean, err: String, elapsed: String)  extends Tile38Error
case class Tile38KeyNotFoundError(ok: Boolean, err: String, elapsed: String) extends Tile38Error
